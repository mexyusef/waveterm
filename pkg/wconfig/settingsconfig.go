...
type AIModeConfigType struct {
	...
	Provider           string   `json:"ai:provider,omitempty" jsonschema:"enum=wave,enum=google,enum=openrouter,enum=openai,enum=azure,enum=azure-legacy,enum=custom,enum=cerebras,enum=sambanova,enum=hyperbolic,enum=groq"`
